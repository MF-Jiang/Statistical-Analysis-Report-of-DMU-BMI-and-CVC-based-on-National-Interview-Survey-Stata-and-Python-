...
gen men = HOUTENURE_A==1
gen women = HOUTENURE_A==2


quietly:graph bar (mean) men women, over(CHDEV_A, label(labsize(*0.5))) nofill bargap(-30) ytitle("Rate",size(small)) graphregion(margin(small)) ylabel(0 "0%" 0.2 "20%" 0.4 "40%"  0.6 "60%", angle(0) labsize(*0.6)) legend(label(1 "Owned or being bought") label(2 "Rented") size(*0.5)) title("Coronary Heart Disease",size(*0.7))
quietly:graph save "./Image/residence-CHDEV_A.gph", replace

quietly: graph bar (mean) men women, over(ANGEV_A, label(labsize(*0.5))) nofill bargap(-30) ytitle("Rate",size(small)) graphregion(margin(small)) ylabel(0 "0%" 0.2 "20%" 0.4 "40%"  0.6 "60%", angle(0) labsize(*0.6)) legend(label(1 "Owned or being bought") label(2 "Rented") size(*0.5)) title("Anginar",size(*0.4))
quietly:graph save "./Image/residence-ANGEV_A.gph", replace

quietly: graph bar (mean) men women, over(MIEV_A, label(labsize(*0.5))) nofill bargap(-30) ytitle("Rate",size(small)) graphregion(margin(small)) ylabel(0 "0%" 0.2 "20%" 0.4 "40%"  0.6 "60%", angle(0) labsize(*0.6)) legend(label(1 "Owned or being bought") label(2 "Rented") size(*0.5)) title("Heart Attack",size(*0.7))
quietly:graph save "./Image/residence-MIEV_A.gph", replace

quietly: graph bar (mean) men women, over(STREV_A, label(labsize(*0.5))) nofill bargap(-30) ytitle("Rate",size(small)) graphregion(margin(small)) ylabel(0 "0%" 0.2 "20%" 0.4 "40%"  0.6 "60%", angle(0) labsize(*0.6)) legend(label(1 "Owned or being bought") label(2 "Rented") size(*0.5)) title("Stroke",size(*0.6))
quietly:graph save "./Image/fresidence-STREV_A.gph", replace


graph combine "./Image/residence-CHDEV_A.gph" "./Image/residence-ANGEV_A.gph" "./Image/residence-MIEV_A.gph" "./Image/fresidence-STREV_A.gph", rows(2)
